...
// The only one I really had trouble passing was #8, since the language was a little confusing to me. Once I figured out exactly what the test was asking for, it was easy. I didn't struggle with the syntax at all.
//How difficult was it to add and delete properties outside of the object itself?
//Very easy. I had read about the delete function in Eloquent JS, so I knew I could use that. At first I tried using it Ruby style like terah.eyecolor.delete, but once that didn't work I just looked it up in the JS docs.
//What did you learn about manipulating objects in this challenge?
// I learned pretty much everything about it! How to do it, how to create objects and manipulate the data. I'm sure my practice with Ruby hashes made this exercise a lot easier.
// __________________________________________
